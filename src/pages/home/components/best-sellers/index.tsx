...
function BestSellingItems() {
  ...
  return (
    <div className="bg-white pt-6.25 pb-3.5 border border-[#EBEBEB] rounded-md mb-5">
      <div className="flex items-center justify-between px-6.25 mb-1.5">
        <h1 className="font-semibold text-[27px] text-[#484848]">Best Selling Items</h1>
          ...
          {res.data.map((item) => (
            <tr key={item.id} className="border-b border-[#EFEFEF] [&>td]:px-6.25 [&>td]:py-2.75">
              ...
              <td>
                ...
                <p className="tracking-[0.02em] text-[#989898]">Price</p>
              </td>
              <td>
                <p className="text-xl tracking-[0.02em] text-[#484848]">{item.orders}</p>
                <p className="tracking-[0.02em] text-[#989898]">Orders</p>
              </td>
              <td>
                <p className={`text-xl tracking-[0.02em] ${item.stock === "No" ? "text-[#DE7E7E]" : "text-[#484848]"}`}>
                  {item.stock}
                </p>
                <p className="tracking-[0.02em] text-[#989898]">Stock</p>
              </td>
              <td>
                <p className="text-xl tracking-[0.02em] text-[#484848]">{item.amount}</p>
                <p className="tracking-[0.02em] text-[#989898]">Amount</p>
              </td>
            </tr>
          ))}
        </tbody>
...
function TopSellers() {
  ...
  return (
    <div className="bg-white pt-6.25 pb-3.5 border border-[#EBEBEB] rounded-md mb-5">
      <div className="flex items-center justify-between px-6.25 mb-1.5">
        <h1 className="font-semibold text-[27px] text-[#484848]">Top Sellers</h1>
            ...
            <tr key={item.id} className="border-b border-[#EFEFEF] [&>td]:px-6.25 [&>td]:py-2.75">
              <td>
                <span className="flex items-center gap-2.25">
                  ...
                  <span className="flex flex-col">
                    <p className="font-semibold text-lg tracking-[0.02em] text-[#484848]">{item.store}</p>
                    <p className="tracking-[0.02em] text-[#989898]">{item.name}</p>
                  </span>
                </span>
              </td>
              <td>
              ...
              <td>
                <span className="flex items-center gap-1.5">
                  <p className="font-semibold text-xl tracking-[0.02em] text-[#484848]">{item.increase}</p>
                  <ChevronUp className="text-[#88B267]" />
                </span>
              </td>
            </tr>
          ))}
